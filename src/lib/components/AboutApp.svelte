...
>
  ...
  <section space-y-3>
    ...
    <p>
      一次照常在周五看完周刊内容后，最下面的往期回顾里面有个题目是<a
        href="https://mp.weixin.qq.com/s/9kDpph9Pm-2QXRnQQ8Ec-A"
        target="_blank"
        rel="noopener"
        class="text-green underline">《人类和人生的意义》</a
      >，作为一个曾经也被这个问题困惑的人，我自然就去看看有什么高见。
    </p>

    <p>
      文章开头提到阮老师在读《季羡林文集》，又说到了这本书的序是季羡林的儿子季承（中国科学院高能物理所高级工程师）写的，序的主题就是这个<a
        href="https://mp.weixin.qq.com/s/9kDpph9Pm-2QXRnQQ8Ec-A"
        target="_blank"
        rel="noopener"
        class="text-green underline">《人类和人生的意义》</a
      >， 主要观点是：<strong>人生的意义就在于为没有意义的人类工作</strong
      >，并且作者觉得对自己有很大启发。
    </p>
  ...
  <section space-y-3>
    ...
    <p>
      要研究我们活着的意义，不妨注意到生的对立面我们为什么要死亡。有句话是"未知死，焉知生"，知道为什么要死，对于明白为什么要活着如何活着相当于钥匙的作用。
    </p>
    ...
    >
      ...
      <p>
        所以这样来说人类存在的目的得到了明确，每个人也可以像那成为人来到地上的一样说"我为此而生，也为此来到世间，特为给真理作见证"。<strong
          >所以明白真理，认清善恶，选择自己的立场，尽快的结束这场对决，就是人类和每个人的人生意义。</strong
        >
      </p>
    </blockquote>
  </section>
  ...
  <section space-y-3>
    ...
    <p>
      读《末时大事记》时看到里面提到，上天最后使用无法追溯起源的媒介使多人看到亮光，好使荣耀归给上天而不是人。我一直在思考在这场戏剧之中我能为这个社会做点什么有用的有价值的东西呢，上帝要我做什么呢？
    </p>

    <p>
      因为看到了乡村生活，所以我们也一直在避免在繁华的城市中生活，并且在不断研究学习如何为将来预备。最近在一处偏僻的乡间，经常没有信号，就是安装了些设备，效果也不是太好。平常也一直用电子设备上网查询学习真理的知识，在这里也不太方便。
    </p>

    <p>
      因为是做技术的缘故，在网上看到国内比较有名的语雀云笔记因服务故障导致所有用户在半天无法打开使用自己的文档。一个周五的晚上，想搜索一些内容，我因没有网络无法打开灵修的书而苦恼。突然有个想法做一个应用把自己没有网络时不能阅读和搜索的问题解决了。
    </p>
    ...
    <section space-y-2 class="bg-green/5 rounded-xl p-4 border border-green/20">
      ...
      <div class="space-y-2 text-xs">
        <div class="flex gap-2">
          <span class="text-green font-700 flex-shrink-0">1.</span>
          <span
            >我需要你告诉我这是不是一件有价值和有意义的事情。如果你也是一位灵感话语的读者，你在使用现有的灵修工具时有什么苦恼和痛点，请告诉我以帮助设计和制造产品。</span
          >
        </div>
        <div class="flex gap-2">
          <span class="text-green font-700 flex-shrink-0">2.</span>
          <span
            >我需要将来作出的应用可以被用户使用，所以需要符合国家法律和政策。如果有相关资源资质并且支持这件事，请联系我。</span
          >
        </div>
        <div class="flex gap-2">
          <span class="text-green font-700 flex-shrink-0">3.</span>
          <span
            >我需要经济援助，研究支撑应用的技术并开发制作出来，需要花费大量的时间和精力。如果你有能力，并且乐意看到这事的成就，请联系我。</span
          >
        </div>
      </div>
      ...
      <p class="text-xs text-gray-400 mt-2">
        有朋友告诉我了一个公众号：<strong class="text-green">研经良助</strong
        >，去研究下是否满足我的需求。
      </p>
    </section>
  </section>
